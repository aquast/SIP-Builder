...
public class ContractRights {
	...
	PublicationRights getInstitutionRights() {
		return institutionRights;
	}

	PublicationRights getPublicRights() {
		return publicRights;
	}

	ConversionCondition getConversionCondition() {
		return conversionCondition;
	}

	void setConversionCondition(String conversionCondition) {
		this.conversionCondition = Utilities.translateConversionCondition(conversionCondition);
	}

	boolean getDdbExclusion() {
		return ddbExclusion;
	}

	void setDdbExclusion(boolean ddbExclusion) {
