...
class GuiMessageWriter extends MessageWriter {
	...
	public void showMessage(String message, int type) {
		...
		if (type == JOptionPane.PLAIN_MESSAGE)
			JOptionPane.showMessageDialog(gui, message, "DA NRW SIP-Builder", type, new ImageIcon(iconImage));
		else
	...
	public void showZeroByteFileMessage() {
		...
		JOptionPane.showMessageDialog(gui, message, "DA NRW SIP-Builder", JOptionPane.ERROR_MESSAGE);
	}
