...
class Gui extends JFrame{
	...
	public Gui(String confFolderPath, String dataFolderPath) {
		...
		URL logo = classloader.getResource("images/logo.png");
	...
	private void initializeTextLabels() {
		...
		collectionLabel = new JLabel("SIPs zu einer Lieferung bündeln");
		collectionLabel.setFont(standardFont.deriveFont(12.0f));
		collectionNameLabel = new JLabel("Name der Lieferung: ");
		collectionNameLabel.setFont(standardFont.deriveFont(10.0f));
		collectionNameLabel.setEnabled(false);
	...
	private void initializeTextAreas() {
		...
		collectionArea = new JTextArea();
		collectionArea.setEditable(false);
		collectionArea.setOpaque(false);
		collectionArea.setLineWrap(true);
		collectionArea.setWrapStyleWord(true);
		collectionArea.setFocusable(false);
		collectionArea.setDisabledTextColor(Color.LIGHT_GRAY);
		collectionArea.setEnabled(false);
		collectionArea.setFont(standardFont.deriveFont(12.0f));
		collectionArea.setText("Wenn Sie die erstellten SIPs gebündelt in das DA NRW einspielen möchten, " +
				"können Sie sie zu einer Lieferung gruppieren. Wählen Sie in diesem Fall bitte einen " +
				"Namen für die Lieferung.");
	...
	private void defineElementPositions() {
		...
		collectionArea.setBounds(255, 300, 430, 50);
		collectionCheckBox.setBounds(251, 355, 225, 20);
		collectionNameLabel.setBounds(255, 380, 115, 20);
		collectionNameTextField.setBounds(375, 380, 220, 20);
	...
	private void addElementsToContentPane() {
		...
		startPanel.add(collectionArea);
		startPanel.add(collectionLabel);
		startPanel.add(collectionCheckBox);
		startPanel.add(collectionNameLabel);
		...
		collectionCheckBox.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e){	     
				if(collectionCheckBox.isSelected()){
					collectionNameLabel.setEnabled(true);
					collectionNameTextField.setEnabled(true);
					collectionNameTextField.setEditable(true);
				}
				else{
					collectionNameLabel.setEnabled(false);
					collectionNameTextField.setEnabled(false);
		...
		kindOfSIPBuildingDropDown.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e){
				if (Utilities.translateKindOfSIPBuilding((String) kindOfSIPBuildingDropDown.getSelectedItem())
					...
					collectionArea.setEnabled(true);
					collectionLabel.setEnabled(true);
